...
4. Author decisions queued: estimator initial-state priors; AI-intensity process; Paper A section drafts need author review (drafted by continuation session, not yet author-read).

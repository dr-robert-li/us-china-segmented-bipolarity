...
*Correction, 2026-08-22, recorded rather than made silently: "ten binary analytical choices generate 59,049" is internally inconsistent -- 59,049 is 3^10, and the Olken source describes a ten-table analysis tree implying 3^10 possible regressions (three-way choices, not binary; see `papers/paper-a-measurement/S5-pre-registration.md` section 5.2). The draft follows the source.*
